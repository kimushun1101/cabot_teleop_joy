...
#include "cabot_teleop_joy/cabot_teleop_joy.hpp"

namespace cabot_teleop_joy
{
TeleopJoy::TeleopJoy(const rclcpp::NodeOptions & options)
: Node("cabot_teleop_joy", options)
{
  ...
  auto path = ament_index_cpp::get_package_share_directory("cabot_teleop_joy") + "/config/" +
...
RCLCPP_COMPONENTS_REGISTER_NODE(cabot_teleop_joy::TeleopJoy)
